...
if(isset($_POST['submit'])){
    ...
    if ($uname != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser,user_id from user where username='".$uname."' and password='".$password."'";
...
<style>
    body{
	margin: 0 auto;
	background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYBTq8c0--N613w4uVdnKZIEOQyreXt98jWQ&usqp=CAU");
...
<div class="container">
    ...
    <form method="post" action="">	
            ...
            <input type="submit" id="submit" name="continue" value="CONTINUE" class="btn-login"/>
		
			<input style="margin:10px" type="submit" id="submit" name="switch" value="Switch To Worker" class="btn-login"/>
		</form>
	</div>
