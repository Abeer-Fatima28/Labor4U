...
<?php
    ...
    $worker_name=$_SESSION['wuser'];
        ...
        <h1><?php echo"$wname";?>'s Jobs</h1>
        <?php
        $select="SELECT * FROM complaints JOIN USER ON User_user_id=User_id WHERE Worker_worker_id='".$worker_id."' ";
              ...
              {?>
                  ...
                  <div class="card ">
                      <div class="card-body">
                          ...
                          <p class="card-text time" id="<?php echo $row['User_id'] ?>">Client Name: <?php echo $row['fname'] ?></p>
                          <p class="card-text date" id="<?php echo $row['complain'] ?>">Complaint: <?php echo $row['complain'] ?></p>
                          </div>
                  </div>
                  <?php
